...
/**let labels = [
 ...
 let labels = [
    "hand", "person", "body", "vote", "raisedhand", "bus", "head", "cat",
    "smile", "cow", "diningtable", "dog", "horse", "motorbike", "car",
...
func nonMaxSuppression(boxes: [YOLO.Prediction], limit: Int, threshold: Float) -> [YOLO.Prediction] {
    ...
    NotificationCenter.default.post(name: Notification.Name("update-votes-notification"), object: ["count": active.count])
